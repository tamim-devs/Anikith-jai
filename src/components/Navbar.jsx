...
const Navbar = () => {
  ...
  return (
    <ContainerWrapper>
    <div className="mb-[-50px] mt-[-50px] md:m-auto">
        <nav className="w-full 2 bg-black px-4 sm:px-6 py-4 flex items-center justify-between relative z-50">

        {/* Logo */}
        <Link to="/" className="flex h-40 sm:h-12 w-40 object-contain items-center">
          <img
            src="/images/Logo.png"
            alt="Logo"
            className="h-40 sm:h-12 w-40 object-contain"
          />
        </Link>
